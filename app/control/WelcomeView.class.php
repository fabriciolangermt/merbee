...
class WelcomeView extends TPage
{
    ...
    function __construct()
    {
        ...
        try
        {
            ...
            $qtdPart    = TbPart::count();
            $qtdRep     = TbRep::count();
            $qtdRepItem = TbRepItem::count();
            ...
            $indicator1->enableSection('main', ['title' => 'Beneficiários',             'icon' => 'user',  'background' => 'orange', 'value' => $qtdPart]);
            $indicator2->enableSection('main', ['title' => 'Produtos distribuídos',     'icon' => 'box', 'background' => 'blue',   'value' => $qtdRepItem]);
            $indicator3->enableSection('main', ['title' => 'Famílias impactadas',        'icon' => 'users',        'background' => 'purple', 'value' => $qtdRep]);
