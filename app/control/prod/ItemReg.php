...
class ItemReg extends TPage
{
    ...
    function __construct()
    {
        ...
        $this->form->setFormTitle('Cadastro produtos');
        $this->form->setClientValidation(true);
        
        // create the form fields
        $id          = new TEntry('id');
        $descr       = new TEntry('descr');
        $vl_qtd      = new TEntry('vl_qtd');
        $vl_prc      = new TEntry('vl_prc');
        
        
        $id->setEditable( FALSE );
        
        $vl_qtd->setNumericMask(2, ',', '.', TRUE); // TRUE: process mask when editing and saving
        ...
        $this->form->addActionLink( 'Lista', new TAction(['ItemList', 'onReload']), 'fa:table blue');
        $vbox = new TVBox;
