...
class ItemList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->setActiveRecord('TbItem');            // defines the active record
        $this->setDefaultOrder('id', 'asc');          // defines the default order
        $this->addFilterField('descr', 'like'); // add a filter field
        ...
        $this->form->addActionLink( 'Novo',  new TAction(['ItemReg', 'onEdit']), 'fa:plus green');
        ...
        $col_description = new TDataGridColumn('descr', 'Descrição', 'left', '40%');
        $col_stock       = new TDataGridColumn('vl_qtd', 'Estoque', 'right', '20%');
        ...
        $action1 = new TDataGridAction(['ItemReg', 'onEdit'], ['id'=>'{id}']);
